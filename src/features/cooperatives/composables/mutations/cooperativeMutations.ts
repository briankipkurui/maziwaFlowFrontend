...
export const useCreateCooperativeMutation = () => {
  ...
  return useMutation({
    mutationFn: (payload: CooperativePayload) => cooperativeService.create(payload),
...
export const useUpdateCooperativeMutation = () => {
  ...
  return useMutation({
    mutationFn: ({ id, payload }: { id: string; payload: CooperativePayload }) =>
...
export const useDeleteCooperativeMutation = () => {
  ...
  return useMutation({
    mutationFn: (id: string) => cooperativeService.delete(id),
