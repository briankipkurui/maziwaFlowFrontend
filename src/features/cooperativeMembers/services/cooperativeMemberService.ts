...
class CooperativeMemberService {
  async list(
    ...
    const response = await http.get<CooperativeMemberResponse>(CooperativeMemberEndpoints.list, {
      params: {
        ...params,
        cooperativeId,
      },
  ...
  async getById(cooperativeId: string, id: string): Promise<CooperativeMember> {
    const response = await http.get<CooperativeMember>(CooperativeMemberEndpoints.getById(id), {
      params: {
        cooperativeId,
      },
    });
